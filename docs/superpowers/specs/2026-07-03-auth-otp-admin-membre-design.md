...
```php
return [
  'admin_phone'   => '777301221',   // 9 chiffres (confirmé) → envoi vers +221777301221
...
1. **Numéro admin** : confirmé `777301221` (9 chiffres) → OTP envoyé vers `+221777301221`. Renseigné dans `config.php`.
