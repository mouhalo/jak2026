...
const I18N={
 fr:{nav_accueil:"Le Cheikh",nav_dign:"Dignitaires",nav_jak:"Jeunesse Al Khaïry",nav_galerie:"Galerie",nav_acces:"Plan & Accès",
   ...
   /* Page de dons */
   nav_dons:"Soutenir",
   don_titre:"Soutenez la visite du Cheikh",
   don_intro:"Votre contribution aide à organiser dignement la visite du Cheikh Ould Khaïry. Tout don, même modeste, compte.",
   ...
   don_merci:"Merci pour votre soutien ! Le paiement va s'ouvrir dans une nouvelle fenêtre.",
 ...
 en:{nav_accueil:"The Cheikh",nav_dign:"Dignitaries",nav_jak:"Jeunesse Al Khaïry",nav_galerie:"Gallery",nav_acces:"Map & Access",
   ...
   /* Page de dons */
   nav_dons:"Donate",
   don_titre:"Support the Cheikh's visit",
   don_intro:"Your contribution helps organise the visit of Cheikh Ould Khaïry with dignity. Every gift, however modest, matters.",
   ...
   don_merci:"Thank you for your support! Payment will open in a new window.",
 ...
 wo:{nav_accueil:"Cheikh bi",nav_dign:"Ñi am maqaama",nav_jak:"Jeunesse Al Khaïry",nav_galerie:"Nataal yi",nav_acces:"Palaŋ & Yoon",
   ...
   /* Page de dons */
   nav_dons:"Jàppale",
   don_titre:"Jàppale ganesi Cheikh bi",
   don_intro:"Sa ndimbal day tax ba ganesi Cheikh Ould Khaïry am ci teraanga. Ku nekk sa ndimbal, lu wóor la.",
   ...
   don_merci:"Jërejëf ci sa ndimbal! Joxe gi dina ubbeku ci bunt bu bees.",
 ...
 ff:{nav_accueil:"Ceerno oo",nav_dign:"Tedduɓe",nav_jak:"Jeunesse Al Khaïry",nav_galerie:"Nate",nav_acces:"Kartal & Naatirde",
   ...
   /* Page de dons */
   nav_dons:"Wallitde",
   don_titre:"Wallitde njillu Ceerno oo",
   don_intro:"Ballal maa ina walla yuɓɓinde njillu Ceerno Ould Khaïry no moƴƴiri. Kala ballal, hay so famarfoo, ina haani.",
   ...
   don_merci:"Jaaramaa e ballal maa! Jowgol ngol maa udditaa e windowhesere hesere.",
 ...
 ar:{nav_accueil:"الشيخ",nav_dign:"الأعيان",nav_jak:"شبيبة الخيري",nav_galerie:"معرض الصور",nav_acces:"الخريطة والدخول",
   ...
   /* صفحة التبرعات */
   nav_dons:"تبرّع",
   don_titre:"ادعم زيارة الشيخ",
   don_intro:"تساعد مساهمتكم في تنظيم زيارة الشيخ أولد خيري على أكمل وجه. كل تبرّع مهما صغر يُقدَّر.",
   ...
   don_merci:"شكرًا على دعمكم! سيفتح الدفع في نافذة جديدة.",
