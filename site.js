...
const I18N={
 fr:{nav_accueil:"Le Cheikh",nav_dign:"Dignitaires",nav_jak:"Jeunesse Al Khaïry",nav_galerie:"Galerie",nav_acces:"Plan & Accès",
   ...
   don_envoyer:"Contribuer",
   don_en_cours:"Paiement en cours…",
   don_redir_om:"Vous allez être redirigé vers Orange Money…",
   don_merci:"Merci pour votre soutien !",
   don_payez_hint:"Scannez le QR ou cliquez ci-dessous",
   don_nouveau:"Nouveau don",
   don_modal_titre:"Paiement en cours",
   don_modal_delai:"Temps restant",
   don_delai_depasse:"Délai dépassé",
   don_jai_paye:"J'ai payé — Vérifier",
   don_verification:"Vérification en cours…",
   don_ouvrir_om:"Ouvrir Orange Money",
 ...
 en:{nav_accueil:"The Cheikh",nav_dign:"Dignitaries",nav_jak:"Jeunesse Al Khaïry",nav_galerie:"Gallery",nav_acces:"Map & Access",
   ...
   don_envoyer:"Contribute",
   don_en_cours:"Payment in progress…",
   don_redir_om:"You will be redirected to Orange Money…",
   don_merci:"Thank you for your support!",
   don_payez_hint:"Scan the QR or click below",
   don_nouveau:"New donation",
   don_modal_titre:"Payment in progress",
   don_modal_delai:"Time left",
   don_delai_depasse:"Time expired",
   don_jai_paye:"I've paid — Check",
   don_verification:"Checking…",
   don_ouvrir_om:"Open Orange Money",
 ...
 wo:{nav_accueil:"Cheikh bi",nav_dign:"Ñi am maqaama",nav_jak:"Jeunesse Al Khaïry",nav_galerie:"Nataal yi",nav_acces:"Palaŋ & Yoon",
   ...
   don_envoyer:"Jàppale",
   don_en_cours:"Jëf ci biir…",
   don_redir_om:"Na yëngu dem ci Orange Money…",
   don_merci:"Jërejëf ci sa ndimbal!",
   don_payez_hint:"Scan QR bi walla bës ci suuf",
   don_nouveau:"Jàppale bu bees",
   don_modal_titre:"Jëf ci biir",
   don_modal_delai:"Waxtu bu des",
   don_delai_depasse:"Waxtu wi jeex na",
   don_jai_paye:"Fey naa — Saytu",
   don_verification:"Saytu bi ci biir…",
   don_ouvrir_om:"Ubbi Orange Money",
 ...
 ff:{nav_accueil:"Ceerno oo",nav_dign:"Tedduɓe",nav_jak:"Jeunesse Al Khaïry",nav_galerie:"Nate",nav_acces:"Kartal & Naatirde",
   ...
   don_envoyer:"Wallit",
   don_en_cours:"Jowgol ina yahra…",
   don_redir_om:"Maa fewnaa e Orange Money…",
   don_merci:"Jaaramaa e ballal maa!",
   don_payez_hint:"Saaɗ QR nden walla huɓ wallitol ngon les ɗoo",
   don_nouveau:"Ballal kesum",
   don_modal_titre:"Jowgol ina yahra",
   don_modal_delai:"Saanga keddiiɗo",
   don_delai_depasse:"Saanga timmii",
   don_jai_paye:"Mi yoɓii — Ƴeewto",
   don_verification:"Ƴeewtaango ina yahra…",
   don_ouvrir_om:"Uddit Orange Money",
 ...
 ar:{nav_accueil:"الشيخ",nav_dign:"الأعيان",nav_jak:"شبيبة الخيري",nav_galerie:"معرض الصور",nav_acces:"الخريطة والدخول",
   ...
   don_envoyer:"ساهم",
   don_en_cours:"جارٍ الدفع…",
   don_redir_om:"سيتم تحويلك إلى أورانج موني…",
   don_merci:"شكرًا على دعمكم!",
   don_payez_hint:"امسح الرمز ضوئيًا أو انقر أدناه",
   don_nouveau:"تبرّع جديد",
   don_modal_titre:"جارٍ الدفع",
   don_modal_delai:"الوقت المتبقّي",
   don_delai_depasse:"انتهى الوقت",
   don_jai_paye:"لقد دفعت — تحقّق",
   don_verification:"جارٍ التحقّق…",
   don_ouvrir_om:"فتح أورانج موني",
...
window.renderChrome=function(active){
  ...
  nav.innerHTML=`<div class="in">
    ...
    <a href="dons.html" class="${active==='dons'?'on':''}">${T('nav_dons')}</a>
  ...
  // Bouton flottant "Soutenir" — présent sur toutes les pages SAUF dons.html
  // (où l'action est déjà le contenu de la page). Redirige vers la page de dons.
  if(active!=='dons'){
    const fab=document.createElement('a');
    fab.className='fab-dons';
    fab.href='dons.html';
    fab.setAttribute('aria-label',T('nav_dons'));
